...
if (isset($_POST["update_status"]) && isset($_POST["feedback_id"])) {
    ...
    $update_query = "UPDATE student_feedback SET status = '$status' WHERE id = $feedback_id";
...
$feedback_query = "SELECT sf.*, s.roll_no, s.fname, s.lname, s.email
                   FROM student_feedback sf
                   JOIN students s ON sf.sid = s.sid
                    ...
                    <?php if (mysqli_num_rows($feedback_result) > 0): ?>
                        <?php while ($feedback = mysqli_fetch_assoc($feedback_result)): ?>
                            <tr>
                                ...
                                <td>
                                    <strong><?php echo htmlspecialchars($feedback['roll_no']); ?></strong><br>
